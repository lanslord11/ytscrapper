              ...
              <ul className="space-y-4">
                {videoData.map((video, index) => (
                  <li key={index} className="flex items-start space-x-4">
                    ...
                    {/* replacing thumbnail url to https://i.pinimg.com/originals/13/7a/81/137a8193480f85dc253c1eec525373b4.jpg if not available */}
                    <img
                    src={video.thumbnail || "https://i.pinimg.com/originals/13/7a/81/137a8193480f85dc253c1eec525373b4.jpg"}
